...
const DelegateLedgerConfirmationModal = (props: Props) => {
  const { address, source, open, isLoading, onCloseClick, fee, t } = props;
  ...
  return (
    <Modal
      title={t(
        'components.changeDelegationLedgerConfirmModal.change_delegate_title'
      )}
      open={open}
    ...
    >
      <MainContainer>
        <DescriptionContainer>
          ...
          <SendDes>
            {t(
              'components.changeDelegationLedgerConfirmModal.change_description'
            )}
          </SendDes>
        </DescriptionContainer>
...
export default wrapComponent(DelegateLedgerConfirmationModal);
